...
-------		|	--------------		|	--------
Current (N)	|	socfpga_v2.9.0		|	v2.9
N - 1		|	socfpga_v2.8.1		|	v2.8
...
---------------------		|	---------------------------	|	-------------------------------
Stratix 10			|	Quad-core ARM Cortex-A53	|	23.2
Agilex				|	Quad-core ARM Cortex-A53	|	23.2
...
1. Upgrade Intel SoC FPGA TF-A to version socfpga_v2.9.0
