...
int iossm_mb_init(void)
{
	...
	//status = mbox_send_cmd(MBOX_ID_IOSSM, MBOX_CMD_GET_MEM_INFO, MBOX_CMD_DIRECT, 0, NULL, 1, 0, NULL);
	// if (status) {
		// return status;
	// }
...
int ddr_config_handoff(handoff *hoff_ptr)
{
	...
	// static ddr_handoff = {
		// /* header */
		// HANDOFF_MAGIC_DDR,	//uint32_t	header_magic;
		// 0x14,				//uint32_t	header_device;
		// {0x0, 0x0},			//uint32_t	_pad_0x08_0x10[2];
		// {0x03},				//Dual Port / Dual EMIF;
	// };
