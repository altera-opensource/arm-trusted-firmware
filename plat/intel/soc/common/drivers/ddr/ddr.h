...
#define MBOX_ID_IOSSM					0x00 // Please update according to IOSSM mailbox spec
#define MBOX_CMD_GET_SYS_INFO				0x01
#define MBOX_CMD_GET_MEM_INFO				0x02 // Please update according to IOSSM mailbox spec
...
#define MBOX_CMD_DIRECT					0x00 // Please update according to IOSSM mailbox spec
