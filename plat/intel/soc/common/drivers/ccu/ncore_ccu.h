...
#define wr_DII0_PSSPERIPHS			0xC0F00000 // ((0x0<<9) | (0xf<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII0_LWHPS2FPGA			0xC1100000 // ((0x0<<9) | (0x11<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII0_HPS2FPGA_1G			0xC1200000 // ((0x0<<9) | (0x12<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII0_HPS2FPGA_15G		0xC1600000 // ((0x0<<9) | (0x16<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII0_HPS2FPGA_240G		0xC1A00000 // ((0x0<<9) | (0x1a<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII1_MPFEREGS			0xC0E00200 // ((0x1<<9) | (0xe<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII2_GICREGS				0xC0800400 // ((0x2<<9) | (0x8<<20) | (0x1<<30) | (0x1<<31))
#define wr_DII3_OCRAM				0xC0900600 // ((0x3<<9) | (0x9<<20) | (0x1<<30) | (0x1<<31))
#define wr_DMI_SDRAM_1G_ORDERED		0x81200000 // ((0x0<<9) | (0x12<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_1G				0x81200006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x12<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_2G_ORDERED		0x81300000 // ((0x0<<9) | (0x13<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_2G				0x81300006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x13<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_15G_ORDERED	0x81600000 // ((0x0<<9) | (0x16<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_15G			0x81600006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x16<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_30G_ORDERED	0x81700000 // ((0x0<<9) | (0x17<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_30G			0x81700006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x17<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_240G_ORDERED	0x81a00000 // ((0x0<<9) | (0x1a<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_240G			0x81a00006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x1a<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_480G_ORDERED	0x81b00000 // ((0x0<<9) | (0x1b<<20) | (0x0<<30) | (0x1<<31))
#define wr_DMI_SDRAM_480G			0x81b00006 // ((0x1<<1) | (0x1<<2) | (0x0<<9) | (0x1b<<20) | (0x0<<30) | (0x1<<31))
...
//
int ccu_hps_ram_region_remap(int id, uintptr_t start, uintptr_t end, CCU_REGION_SECURITY_t security, CCU_REGION_PRIVILEGE_t privilege);
//
...
//
int ccu_hps_mem0_region_remap(int id, uintptr_t start, uintptr_t end, CCU_REGION_SECURITY_t security, CCU_REGION_PRIVILEGE_t privilege);
//
