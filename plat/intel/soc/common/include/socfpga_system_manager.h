...
/* FPGA configuration status field masking */
#define SYSMGR_FPGACFG_COMPLETE			BIT(0)
#define SYSMGR_FPGACFG_ERLY_USERMODE		BIT(1)
#define SYSMGR_FPGACONFIG_RDY_MASK					\
	(SYSMGR_FPGACFG_COMPLETE | SYSMGR_FPGACFG_ERLY_USERMODE)
