...
#define FCS_RANDOM_WORD_SIZE		8
#define FCS_PROV_DATA_WORD_SIZE		43

#define FCS_RANDOM_BYTE_SIZE		FCS_RANDOM_WORD_SIZE * 4
#define FCS_PROV_DATA_BYTE_SIZE		FCS_PROV_DATA_WORD_SIZE * 4
