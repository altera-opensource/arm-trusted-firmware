...
#include "../../../../../drivers/cadence/emmc/cdn_mmc.h"
				...
				u_register_t x2, u_register_t x4)
{
	...
	memset(&reverse_handoff_ptr, 0 , sizeof(reverse_handoff_ptr));
	...
	//watchdog_init(100);
	//get_mmc_clk();
	//cdn_mmc_init(&reverse_handoff_ptr);
...
void bl2_el3_plat_arch_setup(void)
{
	const mmap_region_t bl_regions[] = {
		MAP_REGION2(BL2_BASE, BL2_BASE, BL2_END - BL2_BASE,
			MT_MEMORY | MT_RW | MT_SECURE, 0x40000000),
		MAP_REGION2(BL_CODE_BASE, BL_CODE_BASE, BL_CODE_END - BL_CODE_BASE,
			MT_CODE | MT_SECURE, 0x40000000),
		MAP_REGION2(BL_RO_DATA_BASE, BL_RO_DATA_BASE,
			BL_RO_DATA_END - BL_RO_DATA_BASE,
			MT_RO_DATA | MT_SECURE, 0x40000000),
#if USE_COHERENT_MEM_BAR
		MAP_REGION2(BL_COHERENT_RAM_BASE, BL_COHERENT_RAM_BASE,
			BL_COHERENT_RAM_END - BL_COHERENT_RAM_BASE,
			MT_DEVICE | MT_RW | MT_SECURE, 0x40000000),
#endif
		{0},
	};
